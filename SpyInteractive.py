...
body_cascade = cv2.CascadeClassifier('/home/root/haarcascade_fullbody.xml')
...
def checkIntruder(bot):
	...
	peopleCascade = cv2.CascadeClassifier('/home/hoot/haarcascade_frontalface_default.xml')
	frame = getImage()
...
def countPeople(type):
	...
	if(type is None or 'face'):
		...
		peopleCascade = cv2.CascadeClassifier('/home/hoot/haarcascade_fullbody.xml')
